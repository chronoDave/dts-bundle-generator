...
import { packageVersion } from './helpers/package-version.ts';
import { getModifiers, getNodeName, modifiersToMap, recreateRootLevelNodeWithModifiers } from './helpers/typescript.ts';

export type ModuleImportsSet = {
...
export type NeedStripDefaultKeywordResult = {
  needStrip: boolean;
  newName?: string;
};
